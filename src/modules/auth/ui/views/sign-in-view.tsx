            ...
            <form  onSubmit={form.handleSubmit(onSubmit)} className="p-6 lg:p-8">
              <div className="flex flex-col gap-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Button variant={"outline"} type="button" className="w-full hover:cursor-pointer"  onClick={()=>onSocial("google")}>
                    Google
                  </Button>
                  <Button variant={"outline"} type="button" className="w-full hover:cursor-pointer"  onClick={()=>onSocial("github")}>
                    Github
                  </Button>
                </div>
                <Link
